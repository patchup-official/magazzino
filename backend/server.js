...
async function initDB() {
  ...
  // Migrazione: aggiungi colonne slot orario se non esistono
...
initDB().then(() => {
  ...
  // Valutazione Display â router estratto dal modulo
...
const storicoDispRoute = require('./routes/storico_dispositivi_route');
  ...
  app.listen(PORT, '0.0.0.0', () => console.log(`ð Magazzino API v2.6 â port ${PORT}`));
