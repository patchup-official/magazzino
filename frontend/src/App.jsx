                                                  ...
                                                  <div style={{ display:'flex', height:'100vh', background:'#080e1f', overflow:'hidden' }}>
                                                          ...
                                                          <main style={{ flex:1, display:'flex', flexDirection:'column', overflow:'hidden' }}>
                                                              ...
                                                              justifyContent:'space-between', padding:'0 24px', flexShrink:0,
                                                                                ...
                                                                                <div style={{ fontSize:14, fontWeight:600, color:'#e2e8f0' }}>{titles[currentPage]}</div>div>
                                                                  ...
                                                                  borderRadius:8, padding:'5px 12px', cursor:'pointer',
                                                                                                              ...
                                                                                                              <span style={{ fontSize:12 }}>▣</span>span>
                                                                                                              <span style={{ fontSize:12.5, color:'#94a3b8' }}>Negozio principale</span>span>
                                                                                                              <span style={{ fontSize:10, color:'#475569' }}>▾</span>span>
                                                                                                </div>div>
                                                                                </div>div>
                                                                    </div>div>
                                              ...
                                              function Clock() {
                                                  const [time, setTime] = useState('')
                                                      useEffect(() => {
                                                          ...
                                                          return <span style={{ fontSize:12, color:'#475569', fontFamily:'monospace' }}>{time}</span>span>
                                                            }</div>/ App.jsx — con menu Crea nuovo
