...
const navMagazzino=[{id:'magazzino',icon:'📦',label:'Magazzino'},{id:'cassa',icon:'💰',label:'Cassa'},{id:'acquisto',icon:'◈',label:'Acquisto dispositivo'},{id:'storico-dispositivi',icon:'📱',label:'Storico Acquisti'},{id:'protezione',icon:'🛡️',label:'Protezione'},{id:'valutazione',icon:'📊',label:'Valutazione Display'},{id:'noleggio',icon:'🔄',label:'Noleggio'},{id:'prenotazioni',icon:'📋',label:'Prenotazione Ordini'}]
